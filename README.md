...
## RESULT:
Thus to develop a Django application to store and retrieve data from a Movies Database using Object Relational Mapping(ORM) has been executed sucesfully
